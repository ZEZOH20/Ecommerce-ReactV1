        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              onBlur={handleBlur}
            />
            <label className="floating_label" htmlFor="floating_name">
              Name
            </label>
          </div>

          {errors.name && touched.name && (
            <div role="alert" className="alert_box">
              {errors.name}
            </div>
          )}
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              onBlur={handleBlur}
            />
            <label className="floating_label" htmlFor="floating_phone">
              Phone
            </label>
          </div>
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              onBlur={handleBlur}
            />
            <label className="floating_label" htmlFor="floating_email">
              Email
            </label>
          </div>
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              onBlur={handleBlur}
            />
            <label className="floating_label" htmlFor="floating_password">
              Password
            </label>
          </div>
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              onBlur={handleBlur}
            />
            <label className="floating_label" htmlFor="floating_rePassword">
              rePassword
            </label>
          </div>
